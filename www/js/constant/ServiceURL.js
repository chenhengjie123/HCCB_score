...
ServiceURL.SERVER = '127.0.0.1'
ServiceURL.ACCOUNT = ServiceURL.SERVER + '/accout'
ServiceURL.ACTIVITY = ServiceURL.SERVER + '/activity'
ServiceURL.HISTORY = ServiceURL.SERVER + '/history'
